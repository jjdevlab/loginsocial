                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a class="btn" style="background-color: #000000; color:#fff;"
                                    ...
                                    <a class="btn" style="background-color: #395693; color:#fff;"
                                    ...
                                    <a class="btn" style="background-color: #DC3F1E; color:#fff;"
                                    ...
                                    <a class="btn" style="background-color: #6E85D3; color:#fff;"
